...
./flash.sh AmebaZ2 /dev/ttyUSB0 path/to/image.bin

# Flash a single image to AmebaZ2 at a custom address
./flash.sh AmebaZ2 /dev/ttyUSB0 path/to/factorydata.bin 0x083FF000

# Flash an AmebaD board using GCC-RELEASE directory
./flash.sh AmebaD /dev/ttyUSB0 path/to/GCC-RELEASE

# Flash an AmebaD board with a specific image and custom address
./flash.sh AmebaD /dev/ttyUSB0 path/to/factorydata.bin 0x083FF000
```
