...
The AWS demo source code is centralized in [demos/demo_entry/aws_main.c](../demos/demo_entry/aws_main.c), with the primary entry point identified as aws_main. Realtek provides nine comprehensive examples to demonstrate core AWS IoT capabilities:
