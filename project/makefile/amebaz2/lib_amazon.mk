...
INCLUDES += -I$(SDKROOTDIR)/component/common/network/lwip/$(LWIP_VERSION)/src/include
INCLUDES += -I$(SDKROOTDIR)/component/common/network/lwip/$(LWIP_VERSION)/src/include/lwip
INCLUDES += -I$(SDKROOTDIR)/component/common/network/lwip/$(LWIP_VERSION)/port/realtek
INCLUDES += -I$(SDKROOTDIR)/component/common/network/lwip/$(LWIP_VERSION)/port/realtek/freertos
...
SRC_C += $(AWS_FREERTOS_DIR)/libraries/coreMQTT/source/core_mqtt_serializer_private.c
SRC_C += $(AWS_FREERTOS_DIR)/libraries/coreMQTT/source/core_mqtt_prop_serializer.c
SRC_C += $(AWS_FREERTOS_DIR)/libraries/coreMQTT/source/core_mqtt_prop_deserializer.c
##coreMQTT-Agent
...
##fleet_provisioning
SRC_C += $(AWS_FREERTOS_DIR)/libraries/fleet_provisioning_for_aws/source/fleet_provisioning.c
##freertos_plus
#standard
#crypto
...
###vendor
##port
SRC_C += $(AWS_FREERTOS_DIR)/ports/ota/aws_ota_ameba.c
SRC_C += $(AWS_FREERTOS_DIR)/ports/ota/aws_ota_streams_ameba.c
SRC_C += $(AWS_FREERTOS_DIR)/ports/ota/ota_pal.c
SRC_C += $(AWS_FREERTOS_DIR)/ports/ota/ota_pal_streams.c
SRC_C += $(AWS_FREERTOS_DIR)/ports/pkcs11/core_pkcs11_pal_ameba.c
SRC_C += $(AWS_FREERTOS_DIR)/ports/secure_sockets/iot_secure_sockets.c
SRC_C += $(AWS_FREERTOS_DIR)/ports/wifi/iot_wifi.c
...
SRC_C += $(AWS_FREERTOS_DIR)/demos/fleet_provisioning/fleet_provisioning_csr/fleet_provisioning_csr_demo.c
SRC_C += $(AWS_FREERTOS_DIR)/demos/fleet_provisioning/fleet_provisioning_keys_cert/fleet_provisioning_keys_cert_demo.c
SRC_C += $(AWS_FREERTOS_DIR)/demos/fleet_provisioning/common_operations/mqtt_operations.c
SRC_C += $(AWS_FREERTOS_DIR)/demos/fleet_provisioning/common_operations/pkcs11_operations.c
SRC_C += $(AWS_FREERTOS_DIR)/demos/fleet_provisioning/common_operations/fleet_provisioning_serializer.c

#example_amazon_freertos.c
SRC_C += $(AWS_FREERTOS_DIR)/demos/demo_entry/aws_main.c
SRC_C += $(AWS_FREERTOS_DIR)/demos/demo_entry/example_amazon_freertos.c
...
# -------------------------------------------------------------------
OTA_PATCH_SRC = $(AWS_FREERTOS_DIR)/ports/patches/ota_for_aws/ota.c
OTA_PATCH_DST = $(AWS_FREERTOS_DIR)/libraries/ota_for_aws/source/ota.c

.PHONY: aws_ota_patch
aws_ota_patch:
	cp -f $(OTA_PATCH_SRC) $(OTA_PATCH_DST)

# Compile
# -------------------------------------------------------------------

.PHONY: lib_amazon
lib_amazon: aws_ota_patch prerequirement $(SRC_O) $(DRAM_O)
